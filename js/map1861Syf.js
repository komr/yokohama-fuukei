function map1861Syf(mapId, map_container) {
...
//$(function () {
//    const sidebarId = 'sidebar_1861_syf';
//    const map = map_1861_syf;
    const maxNativeZoom = maxNativeZoom_1861_syf;
    const maxZoom = maxZoom_1861_syf;
    const minZoom = minZoom_1861_syf;
    const image_width = image_width_1861_syf;
    const image_height = image_height_1861_syf;
    ...
    const geojson_spot = "spot_1861_syf.geojson";
