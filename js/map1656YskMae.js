function map1656YskMae(mapId, map_container) {
    ...
    if (map_container === "map_1"){
        ...
        var z_map = { map656_ysk_mae: 3, map_1851_ymkz: 2, map_1859_ykjz: 3, map_1860_tyf: 7, map_1860_ymi: 7, map_1861_gkyz: 2, map_1861_syf: 4, map_1865_gkyzz: 4, map_1868_ymzz: 3, map_now: 16 };
        ...
        function spotOverlay(data, layerName) {
            var spot_geoj = L.geoJSON(data, {
                ...
                onEachFeature: function (feature, layer) {
                    ...
                    //            layer.on('mouseout', function (e) { map_1.closePopup() });
                }
            });
